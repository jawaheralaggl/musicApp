...
class playerVC: UIViewController {
    ...
    func configure() {
        ...
        UserDefaults.init(suiteName: "group.com.jawaher.widget")?.setValue(songNameLabel.text, forKey: "name1")
        UserDefaults.init(suiteName: "group.com.jawaher.widget")?.setValue(artistNameLabel.text, forKey: "name3")
        UserDefaults.init(suiteName: "group.com.jawaher.widget")?.setValue(song.trackName, forKey: "track")
        UserDefaults.init(suiteName: "group.com.jawaher.widget")?.setValue(position, forKey: "trackPosition")
